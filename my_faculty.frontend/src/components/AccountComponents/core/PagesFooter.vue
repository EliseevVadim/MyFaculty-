    ...
    >
        ...
        >
            <v-card-title>
                ...
                <v-spacer></v-spacer>
                <a href="https://vk.com/donnu_dnr" class="social-link mx-4" style="margin-top: 14px">
...
export default {
    ...
    data() {
        return {
            socials: [
                {"icon": 'mdi-facebook', "link": "https://www.facebook.com/DonNU.News/"},
                {"icon": 'telegram', "link": "https://t.me/DonNU_DNR"},
                {"icon": 'mdi-twitter', "link": "https://twitter.com/DonNUDPR"},
                {"icon": 'mdi-youtube', "link": "https://www.youtube.com/@donnuindonetsk"}
            ]
        }
    }
}
