...
namespace MyFaculty.Persistence.Migrations
{
    ...
    [Migration("20230405091157_AddTaskSubmissionsFunctionalityTables")]
    partial class AddTaskSubmissionsFunctionalityTables
    {
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.PairRepeating", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 4, 5, 12, 11, 56, 656, DateTimeKind.Local).AddTicks(1204),
                            RepeatingName = "Каждую неделю"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 4, 5, 12, 11, 56, 656, DateTimeKind.Local).AddTicks(1805),
                            RepeatingName = "По верхней неделе"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 4, 5, 12, 11, 56, 656, DateTimeKind.Local).AddTicks(1815),
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.WorkDayOfWeek", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 4, 5, 12, 11, 56, 598, DateTimeKind.Local).AddTicks(7576),
                            DaysName = "Понедельник"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 4, 5, 12, 11, 56, 601, DateTimeKind.Local).AddTicks(8706),
                            DaysName = "Вторник"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 4, 5, 12, 11, 56, 601, DateTimeKind.Local).AddTicks(8734),
                            DaysName = "Среда"
                        },
                        new
                        {
                            Id = 4,
                            Created = new DateTime(2023, 4, 5, 12, 11, 56, 601, DateTimeKind.Local).AddTicks(8737),
                            DaysName = "Четверг"
                        },
                        new
                        {
                            Id = 5,
                            Created = new DateTime(2023, 4, 5, 12, 11, 56, 601, DateTimeKind.Local).AddTicks(8740),
                            DaysName = "Пятница"
                        },
                        new
                        {
                            Id = 6,
                            Created = new DateTime(2023, 4, 5, 12, 11, 56, 601, DateTimeKind.Local).AddTicks(8742),
                            DaysName = "Суббота"
                        });
                });
