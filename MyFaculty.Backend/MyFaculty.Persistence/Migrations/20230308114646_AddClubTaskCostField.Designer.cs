...
namespace MyFaculty.Persistence.Migrations
{
    ...
    [Migration("20230308114646_AddClubTaskCostField")]
    partial class AddClubTaskCostField
    {
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.PairRepeating", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 3, 8, 14, 46, 45, 224, DateTimeKind.Local).AddTicks(1016),
                            RepeatingName = "Каждую неделю"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 3, 8, 14, 46, 45, 224, DateTimeKind.Local).AddTicks(1588),
                            RepeatingName = "По верхней неделе"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 3, 8, 14, 46, 45, 224, DateTimeKind.Local).AddTicks(1597),
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.WorkDayOfWeek", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 3, 8, 14, 46, 45, 161, DateTimeKind.Local).AddTicks(2765),
                            DaysName = "Понедельник"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 3, 8, 14, 46, 45, 163, DateTimeKind.Local).AddTicks(8110),
                            DaysName = "Вторник"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 3, 8, 14, 46, 45, 163, DateTimeKind.Local).AddTicks(8137),
                            DaysName = "Среда"
                        },
                        new
                        {
                            Id = 4,
                            Created = new DateTime(2023, 3, 8, 14, 46, 45, 163, DateTimeKind.Local).AddTicks(8140),
                            DaysName = "Четверг"
                        },
                        new
                        {
                            Id = 5,
                            Created = new DateTime(2023, 3, 8, 14, 46, 45, 163, DateTimeKind.Local).AddTicks(8143),
                            DaysName = "Пятница"
                        },
                        new
                        {
                            Id = 6,
                            Created = new DateTime(2023, 3, 8, 14, 46, 45, 163, DateTimeKind.Local).AddTicks(8145),
                            DaysName = "Суббота"
                        });
                });
