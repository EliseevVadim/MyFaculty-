...
namespace MyFaculty.Persistence.Migrations
{
    ...
    [Migration("20230104144501_AddFacultyAndCourseAndGroupsRelationsToUser")]
    partial class AddFacultyAndCourseAndGroupsRelationsToUser
    {
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.PairRepeating", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 1, 4, 17, 45, 1, 7, DateTimeKind.Local).AddTicks(1927),
                            RepeatingName = "Каждую неделю"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 1, 4, 17, 45, 1, 7, DateTimeKind.Local).AddTicks(2501),
                            RepeatingName = "По верхней неделе"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 1, 4, 17, 45, 1, 7, DateTimeKind.Local).AddTicks(2509),
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.WorkDayOfWeek", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 1, 4, 17, 45, 0, 942, DateTimeKind.Local).AddTicks(5204),
                            DaysName = "Понедельник"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 1, 4, 17, 45, 0, 946, DateTimeKind.Local).AddTicks(1786),
                            DaysName = "Вторник"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 1, 4, 17, 45, 0, 946, DateTimeKind.Local).AddTicks(1816),
                            DaysName = "Среда"
                        },
                        new
                        {
                            Id = 4,
                            Created = new DateTime(2023, 1, 4, 17, 45, 0, 946, DateTimeKind.Local).AddTicks(1820),
                            DaysName = "Четверг"
                        },
                        new
                        {
                            Id = 5,
                            Created = new DateTime(2023, 1, 4, 17, 45, 0, 946, DateTimeKind.Local).AddTicks(1823),
                            DaysName = "Пятница"
                        },
                        new
                        {
                            Id = 6,
                            Created = new DateTime(2023, 1, 4, 17, 45, 0, 946, DateTimeKind.Local).AddTicks(1824),
                            DaysName = "Суббота"
                        });
                });
