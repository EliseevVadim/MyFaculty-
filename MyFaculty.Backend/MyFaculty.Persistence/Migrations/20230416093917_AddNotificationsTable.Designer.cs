...
namespace MyFaculty.Persistence.Migrations
{
    ...
    [Migration("20230416093917_AddNotificationsTable")]
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.PairRepeating", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 4, 16, 12, 39, 15, 325, DateTimeKind.Local).AddTicks(9399),
                            RepeatingName = "Каждую неделю"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 4, 16, 12, 39, 15, 326, DateTimeKind.Local).AddTicks(188),
                            RepeatingName = "По верхней неделе"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 4, 16, 12, 39, 15, 326, DateTimeKind.Local).AddTicks(199),
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.WorkDayOfWeek", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 4, 16, 12, 39, 15, 123, DateTimeKind.Local).AddTicks(2064),
                            DaysName = "Понедельник"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 4, 16, 12, 39, 15, 127, DateTimeKind.Local).AddTicks(4444),
                            DaysName = "Вторник"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 4, 16, 12, 39, 15, 127, DateTimeKind.Local).AddTicks(4493),
                            DaysName = "Среда"
                        },
                        new
                        {
                            Id = 4,
                            Created = new DateTime(2023, 4, 16, 12, 39, 15, 127, DateTimeKind.Local).AddTicks(4500),
                            DaysName = "Четверг"
                        },
                        new
                        {
                            Id = 5,
                            Created = new DateTime(2023, 4, 16, 12, 39, 15, 127, DateTimeKind.Local).AddTicks(4504),
                            DaysName = "Пятница"
                        },
                        new
                        {
                            Id = 6,
                            Created = new DateTime(2023, 4, 16, 12, 39, 15, 127, DateTimeKind.Local).AddTicks(4508),
                            DaysName = "Суббота"
                        });
                });
