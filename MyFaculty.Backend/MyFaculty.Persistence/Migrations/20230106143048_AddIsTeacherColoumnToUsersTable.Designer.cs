...
namespace MyFaculty.Persistence.Migrations
{
    ...
    [Migration("20230106143048_AddIsTeacherColoumnToUsersTable")]
    partial class AddIsTeacherColoumnToUsersTable
    {
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.PairRepeating", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 1, 6, 17, 30, 47, 275, DateTimeKind.Local).AddTicks(9366),
                            RepeatingName = "Каждую неделю"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 1, 6, 17, 30, 47, 275, DateTimeKind.Local).AddTicks(9982),
                            RepeatingName = "По верхней неделе"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 1, 6, 17, 30, 47, 275, DateTimeKind.Local).AddTicks(9991),
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.WorkDayOfWeek", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 1, 6, 17, 30, 47, 225, DateTimeKind.Local).AddTicks(4156),
                            DaysName = "Понедельник"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 1, 6, 17, 30, 47, 226, DateTimeKind.Local).AddTicks(6558),
                            DaysName = "Вторник"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 1, 6, 17, 30, 47, 226, DateTimeKind.Local).AddTicks(6583),
                            DaysName = "Среда"
                        },
                        new
                        {
                            Id = 4,
                            Created = new DateTime(2023, 1, 6, 17, 30, 47, 226, DateTimeKind.Local).AddTicks(6586),
                            DaysName = "Четверг"
                        },
                        new
                        {
                            Id = 5,
                            Created = new DateTime(2023, 1, 6, 17, 30, 47, 226, DateTimeKind.Local).AddTicks(6589),
                            DaysName = "Пятница"
                        },
                        new
                        {
                            Id = 6,
                            Created = new DateTime(2023, 1, 6, 17, 30, 47, 226, DateTimeKind.Local).AddTicks(6591),
                            DaysName = "Суббота"
                        });
                });
