...
namespace MyFaculty.Persistence.Migrations
{
    ...
    [Migration("20230405104711_AddTimestampsAndNullableRelationOnSubmissionsTables")]
    partial class AddTimestampsAndNullableRelationOnSubmissionsTables
    {
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.PairRepeating", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 4, 5, 13, 47, 10, 551, DateTimeKind.Local).AddTicks(833),
                            RepeatingName = "Каждую неделю"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 4, 5, 13, 47, 10, 551, DateTimeKind.Local).AddTicks(1753),
                            RepeatingName = "По верхней неделе"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 4, 5, 13, 47, 10, 551, DateTimeKind.Local).AddTicks(1767),
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.TaskSubmission", b =>
                {
                    ...
                    b.Property<string>("Status")
                        ...
                        .ValueGeneratedOnAdd()
                        .HasColumnType("longtext")
                        .HasDefaultValue("PendingSubmission");
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.WorkDayOfWeek", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 4, 5, 13, 47, 10, 441, DateTimeKind.Local).AddTicks(6412),
                            DaysName = "Понедельник"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 4, 5, 13, 47, 10, 444, DateTimeKind.Local).AddTicks(8031),
                            DaysName = "Вторник"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 4, 5, 13, 47, 10, 444, DateTimeKind.Local).AddTicks(8089),
                            DaysName = "Среда"
                        },
                        new
                        {
                            Id = 4,
                            Created = new DateTime(2023, 4, 5, 13, 47, 10, 444, DateTimeKind.Local).AddTicks(8095),
                            DaysName = "Четверг"
                        },
                        new
                        {
                            Id = 5,
                            Created = new DateTime(2023, 4, 5, 13, 47, 10, 444, DateTimeKind.Local).AddTicks(8101),
                            DaysName = "Пятница"
                        },
                        new
                        {
                            Id = 6,
                            Created = new DateTime(2023, 4, 5, 13, 47, 10, 444, DateTimeKind.Local).AddTicks(8106),
                            DaysName = "Суббота"
                        });
                });
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.TaskSubmission", b =>
                {
                    ...
                    b.HasOne("MyFaculty.Domain.Entities.TaskSubmissionReview", "Review")
                        .WithOne("TaskSubmission")
                        .HasForeignKey("MyFaculty.Domain.Entities.TaskSubmission", "ReviewId");
