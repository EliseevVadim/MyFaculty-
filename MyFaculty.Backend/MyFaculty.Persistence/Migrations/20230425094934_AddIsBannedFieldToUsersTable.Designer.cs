...
namespace MyFaculty.Persistence.Migrations
{
    ...
    [Migration("20230425094934_AddIsBannedFieldToUsersTable")]
    partial class AddIsBannedFieldToUsersTable
    {
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.PairRepeating", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 4, 25, 12, 49, 33, 291, DateTimeKind.Local).AddTicks(5581),
                            RepeatingName = "Каждую неделю"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 4, 25, 12, 49, 33, 291, DateTimeKind.Local).AddTicks(6287),
                            RepeatingName = "По верхней неделе"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 4, 25, 12, 49, 33, 291, DateTimeKind.Local).AddTicks(6297),
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.WorkDayOfWeek", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 4, 25, 12, 49, 33, 226, DateTimeKind.Local).AddTicks(3614),
                            DaysName = "Понедельник"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 4, 25, 12, 49, 33, 230, DateTimeKind.Local).AddTicks(8963),
                            DaysName = "Вторник"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 4, 25, 12, 49, 33, 230, DateTimeKind.Local).AddTicks(8988),
                            DaysName = "Среда"
                        },
                        new
                        {
                            Id = 4,
                            Created = new DateTime(2023, 4, 25, 12, 49, 33, 230, DateTimeKind.Local).AddTicks(8992),
                            DaysName = "Четверг"
                        },
                        new
                        {
                            Id = 5,
                            Created = new DateTime(2023, 4, 25, 12, 49, 33, 230, DateTimeKind.Local).AddTicks(8994),
                            DaysName = "Пятница"
                        },
                        new
                        {
                            Id = 6,
                            Created = new DateTime(2023, 4, 25, 12, 49, 33, 230, DateTimeKind.Local).AddTicks(8996),
                            DaysName = "Суббота"
                        });
                });
