...
namespace MyFaculty.Persistence.Migrations
{
    ...
    [Migration("20221008121731_AddFacultyIdColoumnToCoursesTable")]
    partial class AddFacultyIdColoumnToCoursesTable
    {
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.PairRepeating", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 10, 8, 15, 17, 30, 304, DateTimeKind.Local).AddTicks(3618),
                            RepeatingName = "Каждую неделю"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2022, 10, 8, 15, 17, 30, 304, DateTimeKind.Local).AddTicks(4989),
                            RepeatingName = "По верхней неделе"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2022, 10, 8, 15, 17, 30, 304, DateTimeKind.Local).AddTicks(5003),
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.WorkDayOfWeek", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 10, 8, 15, 17, 30, 212, DateTimeKind.Local).AddTicks(4494),
                            DaysName = "Понедельник"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2022, 10, 8, 15, 17, 30, 215, DateTimeKind.Local).AddTicks(4383),
                            DaysName = "Вторник"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2022, 10, 8, 15, 17, 30, 215, DateTimeKind.Local).AddTicks(4432),
                            DaysName = "Среда"
                        },
                        new
                        {
                            Id = 4,
                            Created = new DateTime(2022, 10, 8, 15, 17, 30, 215, DateTimeKind.Local).AddTicks(4437),
                            DaysName = "Четверг"
                        },
                        new
                        {
                            Id = 5,
                            Created = new DateTime(2022, 10, 8, 15, 17, 30, 215, DateTimeKind.Local).AddTicks(4440),
                            DaysName = "Пятница"
                        },
                        new
                        {
                            Id = 6,
                            Created = new DateTime(2022, 10, 8, 15, 17, 30, 215, DateTimeKind.Local).AddTicks(4444),
                            DaysName = "Суббота"
                        });
                });
