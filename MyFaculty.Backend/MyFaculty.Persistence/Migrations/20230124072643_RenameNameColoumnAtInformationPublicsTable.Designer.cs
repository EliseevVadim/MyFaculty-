...
namespace MyFaculty.Persistence.Migrations
{
    ...
    [Migration("20230124072643_RenameNameColoumnAtInformationPublicsTable")]
    partial class RenameNameColoumnAtInformationPublicsTable
    {
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.PairRepeating", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 1, 24, 10, 26, 42, 352, DateTimeKind.Local).AddTicks(1632),
                            RepeatingName = "Каждую неделю"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 1, 24, 10, 26, 42, 352, DateTimeKind.Local).AddTicks(2524),
                            RepeatingName = "По верхней неделе"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 1, 24, 10, 26, 42, 352, DateTimeKind.Local).AddTicks(2534),
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.WorkDayOfWeek", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 1, 24, 10, 26, 42, 269, DateTimeKind.Local).AddTicks(8069),
                            DaysName = "Понедельник"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 1, 24, 10, 26, 42, 274, DateTimeKind.Local).AddTicks(1132),
                            DaysName = "Вторник"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 1, 24, 10, 26, 42, 274, DateTimeKind.Local).AddTicks(1177),
                            DaysName = "Среда"
                        },
                        new
                        {
                            Id = 4,
                            Created = new DateTime(2023, 1, 24, 10, 26, 42, 274, DateTimeKind.Local).AddTicks(1182),
                            DaysName = "Четверг"
                        },
                        new
                        {
                            Id = 5,
                            Created = new DateTime(2023, 1, 24, 10, 26, 42, 274, DateTimeKind.Local).AddTicks(1185),
                            DaysName = "Пятница"
                        },
                        new
                        {
                            Id = 6,
                            Created = new DateTime(2023, 1, 24, 10, 26, 42, 274, DateTimeKind.Local).AddTicks(1189),
                            DaysName = "Суббота"
                        });
                });
