...
namespace MyFaculty.Persistence.Migrations
{
    ...
    [Migration("20230406070245_CorrectRelationBetweenSubmissionsAndReviews")]
    partial class CorrectRelationBetweenSubmissionsAndReviews
    {
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.PairRepeating", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 4, 6, 10, 2, 44, 960, DateTimeKind.Local).AddTicks(7017),
                            RepeatingName = "Каждую неделю"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 4, 6, 10, 2, 44, 960, DateTimeKind.Local).AddTicks(7595),
                            RepeatingName = "По верхней неделе"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 4, 6, 10, 2, 44, 960, DateTimeKind.Local).AddTicks(7604),
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.WorkDayOfWeek", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 4, 6, 10, 2, 44, 902, DateTimeKind.Local).AddTicks(4875),
                            DaysName = "Понедельник"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 4, 6, 10, 2, 44, 905, DateTimeKind.Local).AddTicks(7824),
                            DaysName = "Вторник"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 4, 6, 10, 2, 44, 905, DateTimeKind.Local).AddTicks(7856),
                            DaysName = "Среда"
                        },
                        new
                        {
                            Id = 4,
                            Created = new DateTime(2023, 4, 6, 10, 2, 44, 905, DateTimeKind.Local).AddTicks(7859),
                            DaysName = "Четверг"
                        },
                        new
                        {
                            Id = 5,
                            Created = new DateTime(2023, 4, 6, 10, 2, 44, 905, DateTimeKind.Local).AddTicks(7861),
                            DaysName = "Пятница"
                        },
                        new
                        {
                            Id = 6,
                            Created = new DateTime(2023, 4, 6, 10, 2, 44, 905, DateTimeKind.Local).AddTicks(7863),
                            DaysName = "Суббота"
                        });
                });
