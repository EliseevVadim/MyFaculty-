...
namespace MyFaculty.Persistence.Migrations
{
    ...
    [Migration("20230123164957_AddInformationPublicsAndPosts")]
    partial class AddInformationPublicsAndPosts
    {
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.PairRepeating", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 1, 23, 19, 49, 56, 852, DateTimeKind.Local).AddTicks(7077),
                            RepeatingName = "Каждую неделю"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 1, 23, 19, 49, 56, 852, DateTimeKind.Local).AddTicks(8345),
                            RepeatingName = "По верхней неделе"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 1, 23, 19, 49, 56, 852, DateTimeKind.Local).AddTicks(8359),
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.WorkDayOfWeek", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 1, 23, 19, 49, 56, 790, DateTimeKind.Local).AddTicks(4020),
                            DaysName = "Понедельник"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 1, 23, 19, 49, 56, 791, DateTimeKind.Local).AddTicks(7365),
                            DaysName = "Вторник"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 1, 23, 19, 49, 56, 791, DateTimeKind.Local).AddTicks(7395),
                            DaysName = "Среда"
                        },
                        new
                        {
                            Id = 4,
                            Created = new DateTime(2023, 1, 23, 19, 49, 56, 791, DateTimeKind.Local).AddTicks(7398),
                            DaysName = "Четверг"
                        },
                        new
                        {
                            Id = 5,
                            Created = new DateTime(2023, 1, 23, 19, 49, 56, 791, DateTimeKind.Local).AddTicks(7401),
                            DaysName = "Пятница"
                        },
                        new
                        {
                            Id = 6,
                            Created = new DateTime(2023, 1, 23, 19, 49, 56, 791, DateTimeKind.Local).AddTicks(7403),
                            DaysName = "Суббота"
                        });
                });
