...
namespace MyFaculty.Persistence.Migrations
{
    ...
    [Migration("20230425133325_AddUsersBansReportsTable")]
    partial class AddUsersBansReportsTable
    {
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.PairRepeating", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 4, 25, 16, 33, 24, 291, DateTimeKind.Local).AddTicks(1324),
                            RepeatingName = "Каждую неделю"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 4, 25, 16, 33, 24, 291, DateTimeKind.Local).AddTicks(1957),
                            RepeatingName = "По верхней неделе"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 4, 25, 16, 33, 24, 291, DateTimeKind.Local).AddTicks(1967),
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.WorkDayOfWeek", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 4, 25, 16, 33, 24, 178, DateTimeKind.Local).AddTicks(818),
                            DaysName = "Понедельник"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 4, 25, 16, 33, 24, 182, DateTimeKind.Local).AddTicks(6980),
                            DaysName = "Вторник"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 4, 25, 16, 33, 24, 182, DateTimeKind.Local).AddTicks(7036),
                            DaysName = "Среда"
                        },
                        new
                        {
                            Id = 4,
                            Created = new DateTime(2023, 4, 25, 16, 33, 24, 182, DateTimeKind.Local).AddTicks(7044),
                            DaysName = "Четверг"
                        },
                        new
                        {
                            Id = 5,
                            Created = new DateTime(2023, 4, 25, 16, 33, 24, 182, DateTimeKind.Local).AddTicks(7048),
                            DaysName = "Пятница"
                        },
                        new
                        {
                            Id = 6,
                            Created = new DateTime(2023, 4, 25, 16, 33, 24, 182, DateTimeKind.Local).AddTicks(7052),
                            DaysName = "Суббота"
                        });
                });
