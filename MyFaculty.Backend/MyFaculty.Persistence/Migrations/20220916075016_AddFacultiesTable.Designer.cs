...
namespace MyFaculty.Persistence.Migrations
{
    ...
    [Migration("20220916075016_AddFacultiesTable")]
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.PairRepeating", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 9, 16, 10, 50, 15, 316, DateTimeKind.Local).AddTicks(9042),
                            RepeatingName = "Каждую неделю"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2022, 9, 16, 10, 50, 15, 317, DateTimeKind.Local).AddTicks(449),
                            RepeatingName = "По верхней неделе"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2022, 9, 16, 10, 50, 15, 317, DateTimeKind.Local).AddTicks(461),
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.WorkDayOfWeek", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2022, 9, 16, 10, 50, 15, 286, DateTimeKind.Local).AddTicks(2413),
                            DaysName = "Понедельник"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2022, 9, 16, 10, 50, 15, 287, DateTimeKind.Local).AddTicks(5299),
                            DaysName = "Вторник"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2022, 9, 16, 10, 50, 15, 287, DateTimeKind.Local).AddTicks(5330),
                            DaysName = "Среда"
                        },
                        new
                        {
                            Id = 4,
                            Created = new DateTime(2022, 9, 16, 10, 50, 15, 287, DateTimeKind.Local).AddTicks(5333),
                            DaysName = "Четверг"
                        },
                        new
                        {
                            Id = 5,
                            Created = new DateTime(2022, 9, 16, 10, 50, 15, 287, DateTimeKind.Local).AddTicks(5336),
                            DaysName = "Пятница"
                        },
                        new
                        {
                            Id = 6,
                            Created = new DateTime(2022, 9, 16, 10, 50, 15, 287, DateTimeKind.Local).AddTicks(5338),
                            DaysName = "Суббота"
                        });
                });
