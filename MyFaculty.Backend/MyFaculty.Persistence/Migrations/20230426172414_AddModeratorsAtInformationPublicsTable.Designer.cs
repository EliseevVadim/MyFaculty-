...
namespace MyFaculty.Persistence.Migrations
{
    ...
    [Migration("20230426172414_AddModeratorsAtInformationPublicsTable")]
    partial class AddModeratorsAtInformationPublicsTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppUserInformationPublic2", b =>
                {
                    b.Property<int>("InformationPublicsAtModerationId")
                        .HasColumnType("int");

                    b.Property<int>("ModeratorsId")
                        .HasColumnType("int");

                    b.HasKey("InformationPublicsAtModerationId", "ModeratorsId");

                    b.HasIndex("ModeratorsId");

                    b.ToTable("UsersModeratesInformationPublics");
                });
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.PairRepeating", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 4, 26, 20, 24, 13, 45, DateTimeKind.Local).AddTicks(1050),
                            RepeatingName = "Каждую неделю"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 4, 26, 20, 24, 13, 45, DateTimeKind.Local).AddTicks(2119),
                            RepeatingName = "По верхней неделе"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 4, 26, 20, 24, 13, 45, DateTimeKind.Local).AddTicks(2135),
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.UserBanReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.WorkDayOfWeek", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTime(2023, 4, 26, 20, 24, 12, 902, DateTimeKind.Local).AddTicks(5099),
                            DaysName = "Понедельник"
                        },
                        new
                        {
                            Id = 2,
                            Created = new DateTime(2023, 4, 26, 20, 24, 12, 909, DateTimeKind.Local).AddTicks(7780),
                            DaysName = "Вторник"
                        },
                        new
                        {
                            Id = 3,
                            Created = new DateTime(2023, 4, 26, 20, 24, 12, 909, DateTimeKind.Local).AddTicks(7852),
                            DaysName = "Среда"
                        },
                        new
                        {
                            Id = 4,
                            Created = new DateTime(2023, 4, 26, 20, 24, 12, 909, DateTimeKind.Local).AddTicks(7863),
                            DaysName = "Четверг"
                        },
                        new
                        {
                            Id = 5,
                            Created = new DateTime(2023, 4, 26, 20, 24, 12, 909, DateTimeKind.Local).AddTicks(7867),
                            DaysName = "Пятница"
                        },
                        new
                        {
                            Id = 6,
                            Created = new DateTime(2023, 4, 26, 20, 24, 12, 909, DateTimeKind.Local).AddTicks(7871),
                            DaysName = "Суббота"
                        });
                });
            ...
            modelBuilder.Entity("AppUserInformationPublic2", b =>
                {
                    b.HasOne("MyFaculty.Domain.Entities.InformationPublic", null)
                        .WithMany()
                        .HasForeignKey("InformationPublicsAtModerationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.UserBanReport", b =>
                {
                    b.HasOne("MyFaculty.Domain.Entities.AppUser", "Administrator")
                        .WithMany("PerformedBanActions")
                        .HasForeignKey("AdministratorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MyFaculty.Domain.Entities.AppUser", "AffectedUser")
                        .WithMany("AppliedBanActions")
            ...
            modelBuilder.Entity("MyFaculty.Domain.Entities.AppUser", b =>
                {
                    b.Navigation("AppliedBanActions");
                    ...
                    b.Navigation("PerformedBanActions");
